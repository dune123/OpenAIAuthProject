...
const LoginPage = () => {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      // No need to navigate manually — user will be redirected on successful login
    } catch (err) {
  ...
  return (
    <>
      <div className="w-screen h-[90vh] flex flex-col items-center pt-20 bg-white pb-40">
          ...
          <div className="w-100 flex flex-col p-4 border-2 border-gray-300 rounded-md transition-all duration-300">
            ...
            >
              ...
              <Button
                ...
                className="bg-blue-500 text-white rounded-md hover:bg-white hover:text-blue-500 hover:border-blue-500 hover:border-2 cursor-pointer"
              >
                Sign in with Google
              </Button>
              ...
              <p
                className="text-gray-300 pl-24 cursor-pointer hover:text-red-500"
                onClick={() => {
                  setLoginForm(false);
        ...
        {/* register form */}
        {registerForm && (
          <div className="w-100 flex flex-col p-4 border-2 border-gray-300 rounded-md">
